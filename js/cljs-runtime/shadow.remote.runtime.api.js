...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_25225 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_25225(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_25226 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_25226(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_25227 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_25227(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_25228 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_25228(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_25229 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_25229(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_25230 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_25230(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__25220,callback){
var map__25221 = p__25220;
var map__25221__$1 = cljs.core.__destructure_map(map__25221);
var input = map__25221__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25221__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25221__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
