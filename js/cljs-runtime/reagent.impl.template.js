...
var G__29137 = o;
reagent.impl.template.goog$module$goog$object.set(G__29137,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__29206__i < G__29206__a.length) {G__29206__a[G__29206__i] = arguments[G__29206__i + 0]; ++G__29206__i;}
  args = new cljs.core.IndexedSeq(G__29206__a,0,null);
} 
...
var G__29138 = o;
reagent.impl.template.goog$module$goog$object.set(G__29138,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__29208__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__29208 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__29209__i = 0, G__29209__a = new Array(arguments.length -  0);
while (G__29209__i < G__29209__a.length) {G__29209__a[G__29209__i] = arguments[G__29209__i + 0]; ++G__29209__i;}
  args = new cljs.core.IndexedSeq(G__29209__a,0,null);
} 
return G__29208__delegate.call(this,args);};
G__29208.cljs$lang$maxFixedArity = 0;
G__29208.cljs$lang$applyTo = (function (arglist__29210){
...
var G__29139 = props;
var G__29139__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29139,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__29139);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29139__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__29140 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__29140,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__29140;
}
})(),id_class);
...
var G__29141 = (cljs.core.count(argv) - first_child);
switch (G__29141) {
case (0):
...
var vec__29145 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29145,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29145,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29145,(2),null);
...
var temp__5808__auto___29225 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___29225 == null)){
} else {
var key_29226 = temp__5808__auto___29225;
(jsprops.key = key_29226);
}
...
var temp__5808__auto___29230 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___29230 == null)){
} else {
var key_29231 = temp__5808__auto___29230;
(jsprops.key = key_29231);
}
...
var temp__5808__auto___29235 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___29235 == null)){
} else {
var key_29236 = temp__5808__auto___29235;
(jsprops.key = key_29236);
}
...
var temp__5808__auto___29241 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___29241 == null)){
} else {
var key_29242 = temp__5808__auto___29241;
(jsprops.key = key_29242);
}
...
var temp__5808__auto___29243 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___29243 == null)){
} else {
var key_29244 = temp__5808__auto___29243;
(jsprops.key = key_29244);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__29154_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__29154_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__29156 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29156,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29156,(1),null);
...
break;
default:
var G__29248 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__29249 = compiler;
v = G__29248;
compiler = G__29249;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template29166 = (function (opts,id,fn_to_element,parse_fn,meta29167){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template29166.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_29168,meta29167__$1){
var self__ = this;
var _29168__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template29166(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta29167__$1));
}));

(reagent.impl.template.t_reagent$impl$template29166.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_29168){
var self__ = this;
var _29168__$1 = this;
return self__.meta29167;
}));

(reagent.impl.template.t_reagent$impl$template29166.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template29166.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template29166.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template29166.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template29166.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template29166.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta29167","meta29167",1670558186,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template29166.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template29166.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template29166");

(reagent.impl.template.t_reagent$impl$template29166.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template29166");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template29166.
 */
reagent.impl.template.__GT_t_reagent$impl$template29166 = (function reagent$impl$template$__GT_t_reagent$impl$template29166(opts,id,fn_to_element,parse_fn,meta29167){
return (new reagent.impl.template.t_reagent$impl$template29166(opts,id,fn_to_element,parse_fn,meta29167));
});
...
return (new reagent.impl.template.t_reagent$impl$template29166(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
